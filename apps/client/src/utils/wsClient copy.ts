...
//     this._status = v;
//     if (
//       this.localEventCallbacks.onStatusChange &&
//       this.localEventCallbacks.onStatusChange.length > 0
//     ) {
...
//         console.error(
//           "ZilaWS: The client is banned from the WebSocket server."
//         );
...
//    * @param callback
//    */
//   public addEventListener<K extends keyof ICallableLocalEvents>(
//     eventType: K,
...
//         throw new Error(
//           `${eventType} listener already has this callback added to it.`
//         );
//       }
//     } else {
//       array = [];
...
//    * @param callback
//    */
//   public onceEventListener<K extends keyof ICallableLocalEvents>(
//     eventType: K,
//     callback: ICallableLocalEvents[K]
//   ) {
//     const that = this;
...
//    * @param callback
//    */
//   public onceMessageHandler(
//     identifier: string,
//     callback: ZilaWSCallback
//   ): void {
