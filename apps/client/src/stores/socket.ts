...
import { defineStore } from "pinia";
import { useAuthStore } from "./auth";
import { WebSocketService } from "@/utils/websocket"; // Assuming this is your WebSocket client utility
...
export const useSocketStore = defineStore("socket", () => {
  ...
  function connectWebSocket() {
    ...
    if (token) {
      ...
      WebSocketService.getInstance().connect(); // Assuming token is handled internally or not needed for initial connect
