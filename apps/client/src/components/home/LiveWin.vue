<script setup lang="ts">
  ...
  const liveWinList = () => {
    let res = [
      ...gameBigWinItem.value.lucky_bets,
      ...gameBigWinItem.value.lucky_bets,
    ];
    // console.log(res.length)
    res.forEach((item) => {
      // console.log(item.game_icon)
      item.game_icon = item.game_icon.replace(
        "/images/games",
        "https://images.cashflowcasino.com"
      );
      // console.log(item.game_icon)
    });
    return res;
...
<template>
  ...
  >
    ...
    >
      <img
        src="/images/bigwin/bigwin-left-pink.png"
        style="height: 133px; margin-left: -20px"
      />
    ...
    <div class="live-win-body" ref="liveWinBody">
      ...
      >
        ...
        >
          <div class="text-center">
            <img
              :src="imgWinList[Math.floor(Math.random() * 3)]"
              class="live-win-img"
            />
            <div class="live-win-level-text">
