  ...
  >
    <div
      ...
      style="
        ...
        border-image: url(&quot;/images/common/cell-2.png&quot;) 20 20 20 20
          fill / 20px 20px 20px 20px;
    ...
    >
      ...
      >
        <div
          class="w-full flex items-center justify-stretch px-1"
          style="width: 100vw"
        >
        ...
        <div v-if="activeName === 'hasPending'">
          <div class="futex-cell-2 glow-light">
            You already have a pending balancetransaction. Would you like to
            cancel it?
          </div>
          <div
